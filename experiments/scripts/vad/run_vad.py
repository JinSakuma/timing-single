...
from src.systems.vad.vad2 import System
from src.utils.setup import process_config
from src.utils.utils import load_json
from src.utils.trainer_vad import trainer
from src.datasets.vad_dataset import get_dataloader, get_dataset
import wandb
...
def run(config_path, gpu_device=-1):
	...
	del train_dataset
	del val_dataset
	#model.asr_model.load_state_dict(torch.load(config.continue_from_checkpoint), strict=False)
	model.to(device)
