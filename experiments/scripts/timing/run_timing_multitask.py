...
from src.systems.timing.timing_all_pred_multitask import System
from src.utils.setup import process_config
from src.utils.utils import load_json
from src.utils.trainer_multitask import trainer
...
def run(config_path, gpu_device=-1):
	...
	if config.resume:
		...
		model.timing_model.load_state_dict(torch.load(config.timing_continue_from_checkpoint), strict=False)
	model.to(device)
