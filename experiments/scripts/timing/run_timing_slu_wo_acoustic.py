...
from src.systems.timing.timing_all_pred_wo_acoustic import System
...
def run(config_path, gpu_device=-1):
	...
	model.slu_model.load_state_dict(torch.load(config.slu_continue_from_checkpoint), strict=False)
