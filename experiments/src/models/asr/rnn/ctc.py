...
class CTC(nn.Module):
    ...
    def __init__(
        ...
        self.word_fc = nn.Linear(hidden_dim * (2 if bidirectional else 1), num_class)
    ...
    def forward(self, inputs, input_lengths):
        ...
        return log_probs, embedding, outputs
    ...
    def ctc_collapse(self, seq, seq_len, blank_index=-1):
        result = []
