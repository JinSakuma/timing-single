...
class System(nn.Module):
	...
	def configure_optimizer_parameters(self):
		parameters = chain(
			#self.slu_model.asr_model.parameters(),
			self.slu_model.dialog_acts_model.parameters(),
			self.slu_model.system_acts_model.parameters(),
	...
	def forward(self, batch, split='train'):
		...
		outputs = self.slu_model(batch, split)
		...
		outputs[f'{split}_loss'] = loss
		outputs[f'{split}_asr_cer'] = asr_cer
