...
class MyHarperValleyTimingDataset(BaseHarperValley):
    ...
    def __init__(
        ...
        self.offset = 300
        dialog_vocab_path = os.path.join(root, 'vocab/dialog_act_vocab2.txt')
        system_vocab_path = os.path.join(root, 'vocab/system_act_vocab2.txt')
    ...
    def __getitem__(self, index):
        ...
        for dl in range(dialog_len):
            ...
            fbank_path = wavpath.replace('.wav', '_fbank.npy').replace('wav', 'fbank2')
